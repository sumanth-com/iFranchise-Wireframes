...
const CONFIG_DATA = {
  ...
  integrations: [
    ...
    { name: "CALLYZER", status: "Planned", screen: "integrations" },
    { name: "Callyzer Business", status: "Planned", screen: "integrations" },
  ...
  featureFlags: [
    ...
    { name: "Enable Call Intelligence", desc: "Call tracking with CALLYZER & Callyzer Business", enabled: true },
